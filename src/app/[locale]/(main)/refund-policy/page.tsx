...
import { useGetRefundPolicy } from "@/app/[locale]/(auth)/sign-up/hooks/use-get-refund";
import Typography from "@/components/shared/typography";

export default function RefundPolicyPage() {
  const locale = useLocale();
  const { policies: refundPolicies, isLoading } = useGetRefundPolicy();
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="max-w-4xl mx-auto">
        {refundPolicies && refundPolicies.length > 0 ? (
          ...
          <div className="text-center py-12">
            <Typography variant="body-lg-bold" as="p" className="text-gray-500">
              {locale === "ar"
                ? "لا توجد سياسة استرجاع متاحة حالياً"
