  ...
  return (
    <section className="bg-main-100 py-20 px-4">
      <div className="container flex flex-col lg:flex-row lg:space-x-28">
        ...
        <div className="relative h-[500px] rounded-lg bg-white bg-cover bg-center bg-no-repeat md:h-[600px] lg:h-auto lg:flex-1">
          <div className="absolute inset-0 rounded-lg bg-gradient-to-br from-main-500/20 to-steelBlue-500/20" >
            <Image
              width={400}
              height={400}
          ...
          <Button
            ...
            to={
              activeTab === "1"
                ...
                : getLocalizedPath("/companies", locale)
            }
